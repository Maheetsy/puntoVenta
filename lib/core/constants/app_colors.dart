...
class AppColors {
  ...
  static const Color cardBackground = Color(0xFFE6F7FF);

  // Primary (Azul) - #00b2fe o #007FFF
  static const Color primary = Color(0xFF00B2FE); // #00b2fe
  static const Color primaryLight = Color(0xFF4DC5FF);
  static const Color primaryDark = Color(0xFF007FFF); // #007FFF
  static const Color primaryContainer = Color(0xFFE6F7FF);
  ...
  // Texto
  static const Color textPrimary = Color(0xFF011627);
  ...
  static const Color productCard = cardBackground;
  static const Color categoryChip = primaryContainer;
